...
description: >
  ...
  start building the technical environment. Also trigger after weave-script completes
  when the user is ready to move from planning to building. Run before weave-train —
...
Before extracting requirements from scratch, check whether `weave-query` has
...
Read `skills/weave-cost/SKILL.md` for the full mapping, seed data spec, and ES|QL
