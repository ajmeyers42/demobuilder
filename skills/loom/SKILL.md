...
7. **Emit session handoff:** `🔁 Next session: attach {primary-output-file} — run {next-stage} [{model-tag}]`
8. **Surface any blockers:** If a stage produces a RED platform audit or critical gaps, pause
