...
Read `{workspace}/{slug}/.env`. All API calls use these credentials. Never hardcode.

If `.env` doesn't exist, stop immediately:
```
ERROR: No .env found at {workspace}/{slug}/.env
...
python3 {workspace}/{slug}/bootstrap.py --step 8
python3 {workspace}/{slug}/bootstrap.py --step 10
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
set -a && source {workspace}/{slug}/.env && set +a
python3 {workspace}/{slug}/bootstrap.py --step 15   # ELSER warm-up
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
